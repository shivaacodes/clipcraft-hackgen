...
export const Icons = {
  Logo: function Logo({
    ...
    return (
      <div
        className={cn(className, "bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center")}
        style={{ width, height }}
      >
        <span className="text-white font-bold" style={{ fontSize: Math.min(width, height) * 0.4 }}>L</span>
      </div>
    );
  },
  ...
  Gmail: function Gmail({
    ...
    return (
      <div
        className={cn(className, "bg-red-500 rounded flex items-center justify-center")}
        style={{ width, height }}
      >
  ...
  Trello: function Trello({
    ...
    return (
      <div
        className={cn(className, "bg-blue-600 rounded flex items-center justify-center")}
        style={{ width, height }}
      >
  ...
  Linear: function Linear({
    ...
    return (
      <div
        className={cn(className, "bg-purple-600 rounded flex items-center justify-center")}
        style={{ width, height }}
      >
  ...
  Slack: function Slack({
    ...
    return (
      <div
        className={cn(className, "bg-green-600 rounded flex items-center justify-center")}
        style={{ width, height }}
      >
  ...
  Notion: function Notion({
    ...
    return (
      <div
        className={cn(className, "bg-gray-800 rounded flex items-center justify-center")}
        style={{ width, height }}
      >
  ...
  ArrowLeft: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  CrossRed: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  CrossMono: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  DelayedYellow: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  DelayedMono: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  OnTrackGreen: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  OnTrackMono: (props: React.ComponentProps<"svg">) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
